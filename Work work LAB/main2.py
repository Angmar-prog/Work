...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "Дата создания"))
        self.label_6.setText(_translate("Dialog", "Дата изменения"))
...
class TriathlonApp(QtWidgets.QDialog, Ui_Dialog):
    ...
    def select_file(self):
        ...
        file_path, _ = QtWidgets.QFileDialog.getOpenFileName(self, "Выберите файл", "", "All Files (*);;", options=options)
        if file_path:
            self.lineEdit.setText(file_path)
            self.display_file_properties(file_path)

    def display_file_properties(self, file_path):
        ...
        self.label_8.setText(file_extension)
        self.label_9.setText(f"{file_size} bytes")
        self.label_10.setText(creation_time)
        self.label_11.setText(modification_time)
        self.label_12.setText("System")
